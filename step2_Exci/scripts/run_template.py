...
# Lowest and highest orbital, Here HOMO is 48
params['lowest_orbital'] = 48-16
params['highest_orbital'] = 49+17
...
params['trajectory_xyz_filename'] = path + '/../dynamics_AIMD.xyz'
